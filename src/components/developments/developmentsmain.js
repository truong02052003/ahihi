...
export default function DevelopmentsBlog() {
    return (
        <div>
            ...
            {/* Các phương pháp thu nước trong thời cổ đại */}
            <div>
                ...
                <img src="./images/pic4.jpg" className="mb-5 w-50 mx-auto d-block" alt="Ancient Harvesting"/>
            </div>

            {/* Thu nước trên mái nhà */}
            <div>
                <div className="container col-sm-5">
                    <p className={styles.paragraph}>
            ...
            <div>
                ...
                <img src="./images/pic6.jpg" className="w-50 mx-auto d-block mb-5" alt="Baoris"/>
                <img src="./images/pic7.jpg" className="w-50 mx-auto d-block mb-5" alt="Baoris"/>
            </div>
