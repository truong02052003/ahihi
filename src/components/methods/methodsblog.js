    ...
    return (
            ...
            <div>
                ...
                <div className="container col-sm-5 mt-5">
                    <p>
                        Before installing your own system, please check to see if your area is suitable to harvest rainwater and be aware of your local laws or regulations on Rainwater Harvesting and available ground, spaces to install suitable systems. <br /><br />
                    </p>
                </div>
            ...
            <div className="container col-sm-5 mt-5">
                <h1 className="title_text">A Successful System</h1>
                <p>
                    The basic principles of rainwater harvesting are rather simple: catch rainwater, store it, use it. But there are components, details, and processes that are critical to the success of a rainwater harvesting system. <br /><br />
                    What do we mean by a successful system? <br /><br />
                    Rainwater harvesting as your main water supply should only bring benefits and improvement to your water, this includes: <br /><br />
                    <b>Water quality: </b> Based on purpose, the water should be clear, odorless, and taste great and needs to be bacteria-free through the use of a water disinfection system such as ultraviolet light or just simply clean, no dust, dirt, insects or any organic matter for non<span>&minus;</span>potable uses. <br /><br />
                    <b>Water pressure: </b> The water should flow at the highest pressure possible without exceeding proper limits. <br /><br />
                    <b>Water storage: </b> The water being stored should be odor-free, slime-free, and clear. <br /><br />
                    <b>System design: </b> The system should be designed to meet the supply and demand of the home and its occupants. What is the sq. ft. roof surface that will be collecting rainwater? What is the average annual/monthly rainfall in the area? How much storage gives enough buffer to supply the house with ease, even with rain lapses? <br /><br />
                    These are 4 points that help in determining a successful rainwater harvesting system, but more aspects are involved even beyond these. <br /><br />
                </p>
            </div>
            ...
            <div>
                <div className="container col-sm-5 mt-5">
                    <h1 className="title_text">Rainwater Harvesting Methods</h1>
                    <p>
            ...
            <div>
                ...
                <div className="container col-sm-5">
                    <p>
                        <b>2. Dry System: </b>This is a well-known method of rainwater harvesting. It<span>&#39;</span>s basically an improvement to the rainwater barrel technique in terms of size. A larger water storage container is situated just a few steps from the property. This container provides a much larger storage capacity compared to the barrel. <br /><br />
                        The gutter is then diverted to channel water into the tank. It<span>&#39;</span>s also easy to implement and relatively cheap. The name “dry” comes from the fact that the collection pipe dries up after any rainy day because it<span>&#39;</span>s meant to empty into the top of the tank. The dry system is ideal for areas with huge storms. <br /><br />
                    </p>
                </div>
            ...
            <div>
                <div className="container col-sm-5">
                    <p>
                        <b>3. Wet System: </b>The wet system is the exact opposite of the dry system. This is because the collection pipes are ever full of water since they are located underground. Here, numerous collection pipes are connected to multiple downspouts on the building and channeled to empty into the storage tank underground. <br /><br />
                    </p>
                </div>
            ...
            <div>
                <iframe
                    ...
                    height="550px"
                    src="https://www.youtube.com/embed/aM1Wyn5dk5g"
            ...
            <div>
                <div className="container col-sm-5">
                    <p>
                        <b>4. Green Roof: </b>This method of rainwater harvesting literally cuts out the middleman. Instead of directing rainwater for storage in the tank and then channel it to the garden; you could install a green roof on your house to enable plants to use the water instantly. But you have to lay down a lining for your roof<span>&#39;</span>s protection and include a drainage system to take care of the runoffs. <br /><br />
                        Installing garden beds with plants that require low maintenance is the surefire way of maximizing your plot<span>&#39;</span>s productive space and leveraging the rainwater where it falls. Also, installing a green roof will add insulation to your house and cushion your roof from damage. <br /><br />
            ...
            <div className="container col-sm-5 mt-n2">
                <h1 className="title_text">Harvesting System Setup</h1>
                <p>
            ...
            <p className="text-center"><i>A complete harvesting system example/model</i></p>
                ...
                <div>
                <div className="container col-sm-5">
                <h1 className="left_title_text">Where the System Starts (Rooftop)</h1>
                <p>
            ...
            <div className="container col-sm-5">
                <h1 className="left_title_text">Diversion (Conveyance)</h1>
                <p>
            ...
            <div className="container col-sm-5">
                <h1 className="left_title_text">Pre-Storage Filtration</h1>
                <p>
            ...
            <div className="container col-sm-5">
                <h1 className="left_title_text">Entering Storage</h1>
                <p>
            ...
            <div className="container col-sm-5">
                <h1 className="left_title_text">Storage</h1>
                <p>
            ...
            <div className="container col-sm-5">
                <h1 className="left_title_text">Overflow | Groundwater Recharge</h1>
                <p>
            ...
            <div className="container col-sm-5">
                <h1 className="left_title_text">Pump</h1>
                <p>
            ...
            <div className="container col-sm-5">
                <h1 className="left_title_text">Exiting the Tank</h1>
                <p>
            ...
            <div className="container col-sm-5">
                <h1 className="left_title_text">Filtration and Controls</h1>
                <p>
            ...
            <div className="container col-sm-5">
                <h1 className="left_title_text">Automatic Crossover to Secondary Water Supply</h1>
                <p>
            ...
            <div className="container col-sm-5">
                <h1 className="left_title_text">Use</h1>
                <p>
        ...
        <div className="container col-sm-5">
                <h1 className="title_text">How To Harvest & Use Water Efficiently</h1>
                <p>
