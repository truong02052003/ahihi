        ...
        <div>
            <section className={styles.body}>
                ...
                <div className={styles.thumbnail}>
                    <img src="images/slogan.png" alt="Slogan" className={styles.bodyImg} />
            ...
            <div className={styles.intro}>
                ...
                <img src="images/Camera Roll/1024px-Rainwater_harvesting_tank_(5981896147).png" alt="Explanation" className={styles.introImg} />
            </div>
                ...
                <div className={styles.methods}>
                    ...
                    <img src="images/Camera Roll/UDDT_with_rainwater_harvesting_(3441547910).png" alt="Rainwater Barrel" className={styles.methodsImg} />
