        ...
        <div>
            ...
            <div className={styles.com_sur_explain}>
                ...
                <div className={styles.com_roof_explain}>
                    ...
                    <img src="images/Camera Roll/roof-com.png" alt="Rooftop Rainwater Harvesting" className={styles.comSurExplainImg} />
                ...
                <div className={styles.com_roof_pros} className="pb-1">
                    <h2 className={styles.comSurProsH2}>Pros:</h2>
